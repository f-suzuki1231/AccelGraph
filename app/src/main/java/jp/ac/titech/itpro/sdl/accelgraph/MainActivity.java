...
public class MainActivity extends Activity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   yView = (GraphView) findViewById(R.id.y_view);
       // zView = (GraphView) findViewById(R.id.z_view);
        ...
        light = sensorMgr.getDefaultSensor(Sensor.TYPE_LIGHT); //変更
        if (light == null) {
    ...
    protected void onResume() {
        super.onResume();
        Log.i(TAG, "onResume");
        sensorMgr.registerListener(this,light, SensorManager.SENSOR_DELAY_NORMAL); //変更
